...
templates['leader'] = template({"compiler":[8,">= 4.3.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<div class=\"lboard_mem\">\n  <div class=\"name_bar\">\n    <p><span></span>"
    ...
    + alias4(((helper = (helper = lookupProperty(helpers,"score") || (depth0 != null ? lookupProperty(depth0,"score") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"score","hash":{},"data":data,"loc":{"start":{"line":8,"column":22},"end":{"line":8,"column":31}}}) : helper)))
    + "</div>\n</div>";
},"useData":true});
})();
